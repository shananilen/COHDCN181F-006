...
while price:
    ...
    try:
        no= float(price)
        if no < 0 :                 #For minus numbers
            print("You entered a Minus Number, Please check the value")
            
        elif no > 100000:           #For huge inputs; assuming that 99999 is the biggest value
            print("You entered a value greater than 1 lack, Please Check")
        else :
            tot = tot + no
